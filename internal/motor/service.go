...
func NewService(nlpURL, prediccionesURL, apiKey string) Service {
...
func (s *motorSyncService) SyncReporteCreado(reporte reporte.ReporteResponse) {
...
func textoReporte(reporte reporte.ReporteResponse) string {
